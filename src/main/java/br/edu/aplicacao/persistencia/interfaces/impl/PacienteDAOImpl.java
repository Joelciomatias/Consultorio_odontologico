...
public  class PacienteDAOImpl extends GenericaDAOImpl<Paciente, Long> implements IPacienteDAO {
	...
	public List<Paciente> listarPacientesPorUsuario(Long id) {
		...
		TypedQuery<Paciente> consultaTipada = getEntityManager().createQuery(sqlFrom.toString(), this.entityClass);
	...
	public List<Paciente> pesquisar(String nome, Long idUsuarioLogado) {
		if(nome == null)
			return this.listarPacientesPorUsuario(idUsuarioLogado);
